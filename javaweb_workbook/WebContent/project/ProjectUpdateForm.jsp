...
<jsp:include page="/Heaer.jsp" />
	...
	<form action='update.do' method='post'>
		...
		<li><label for="no"> 번호</label> <input id="no" type='text'
			...
			<li><label for="sdate"> 시작일</label> <input id="sdate"
				type='text' name='startDate' placeholder="예)2013-01-01" value="${project.startDate }"></li>
			<li><label for="edate"> 종료일</label> <input id="edate"
				type='text' name='EndDate' placeholder="예)2013-01-01" value="${project.endDate }"></li>
			...
			<li><label for="tags"> 태크</label> <input id="tags" type='text'
				name='tags' placeholder="예)태그1 태그2 ... " size="50" value="${project.tags }"></li>
		</ul>
