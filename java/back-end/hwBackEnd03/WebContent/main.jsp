...
<body>
	<h1>메인 페이지</h1>
		...
		<a href="pro.jsp">상품 등록</a> <a href="#">상품 목록 </a> <a href="#">마지막 등록 상품</a>
		<%
			} else {
				// 로그인 한 경우라면 ...
		%>
		<%=loginId%>님 로그인 되었습니다. <a href="pro.jsp">상품 등록</a><a href="lastpro.jsp">마지막 등록 상품</a> <a href="LogoutServlet">로그 아웃
		</a>
		<%
			}
		%>
